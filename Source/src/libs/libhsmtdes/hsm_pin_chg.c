...
/************************************************************************/
char           *
StrMoins(char *sPinBlockC, char *sPinCalc)
{
...
/*Mehdi Elyajizi PCI */
	...
	memset(pin_clair_recu, 0, sizeof(pin_clair_recu));
	memset(sPinCalcul, 0, sizeof(sPinCalcul));
	trace_event("Fin   ChangePin(OK)", PROCESSING);
	return (OK);
}
/************************************************************************/
