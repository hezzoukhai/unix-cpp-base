...
{
   /* EBE140523 DES ( 1 ,(unsigned char) "C" , Source , Key , Source );*/
...
unsigned char Source[], Key[];
{
   /* EBE140523 DES ( -1 ,(unsigned char) "H" , Source , Key , Source );*/
...
unsigned char Source[];
{
   ...
   memset ( T_Key , '0' , 16 );
   /* EBE140523 DES ( 1 , (unsigned char) "H" , Source , T_Key , Source );*/
...
unsigned char Source[];
{
   ...
   memset ( T_Key , 0 , 8 );
   /* EBE140523 DES ( 1 ,  (unsigned char) "C" , Source , T_Key , Source );*/
