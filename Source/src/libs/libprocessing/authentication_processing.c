...
/****************************************************************************/
/****************************************************************************/
int AuthenticationReqProcessing  	(int nIndiceCtx,
				                char *sMyResource,
				 	            char *sAuthoTable, 
								char *sAcquirerBank,
                                ...
                                char *sTlvBuffer , TSIsoInfo *sIsoMsg  )
{
    ...
    trace_event("Start AuthenticationReqProcessing  ()",PROCESSING);
...
/* END LHI 25-05-2008 INIT OF EVENT CODE AND ACTION CODE */                                       
...
/******************************************************************************/
 ...
 /* BEGIN: LHI 25-05-2008 EVENT CODE MUST BE SETTED IN NOK UNTIL ALL CONTROLS ARE OK */
      ...
      trace_event("....	Before AuthorLoaclAdm", FATAL);
...
/* BEGIN: LHI 25-05-2008 EVENT CODE MUST BE SETTED IN NOK UNTIL ALL CONTROLS ARE OK */
					PutTlvBuffer(AUTO_EVENT_CODE, sTlvBuffer, APPROVED_ACTION ,     3);
					trace_event("....	Before AuthorRouting", FATAL);
