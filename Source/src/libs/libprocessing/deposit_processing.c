...
/****************************************************************************/
/****NBD150908 Diebold Protocol Integration Start ***/
/****************************************************************************/
/* Fonction qui traite les demandes de Pre Deposit                         */
/****************************************************************************/
int PreDepositProcessing        (int nIndiceCtx,
                                             char *sMyResource,
                                                 char *sAuthoTable,
                                                         char *sAcquirerBank,
                             ...
                             char *sTlvBuffer , TSIsoInfo *sIsoMsg  )
{
    ...
    trace_event("Start PreDepositProcessing  ()",PROCESSING);
...
char sDepositType [512];

   memset(sDepositType, 0, sizeof(sDepositType));

   GetIsoField( ISO_ADTNL_TRACE_DATA , sIsoMsg, sDepositType, &nLength);
...
/*****NBD150908 Diebold Protocol Integration End ****/
/****************************************************************************/
/* Fonction qui traite les demandes du Deposit                         */
/****************************************************************************/
int DepositProcessing  	(int nIndiceCtx,
				             char *sMyResource,
				 	         char *sAuthoTable, 
							 char *sAcquirerBank,
                             char *InternationalRoutCheck, 
                             ...
                             char *sTlvBuffer , TSIsoInfo *sIsoMsg  )
{
    ...
    trace_event("Start DepositProcessing  ()",PROCESSING);
