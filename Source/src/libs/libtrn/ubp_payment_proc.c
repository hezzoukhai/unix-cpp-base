...
/******************************************************************************/
/******************************************************************************/
int UbpPayProc(int nIndiceCtx, char*	sTlvBuffer)
{

	trace_event("UbpPayProc --> AuthRequestProc", PROCESSING);
        /*remove old UbpPayProc code, and call AuthRequestProc instead*/
