...
/******************************************************************************/
int CardActivationRequestProc(int nIndiceCtx, char*	sTlvBuffer)
{
	...
	trace_event("Start CardActivationRequestProc()", PROCESSING);
	/******************************************************************************/
	/* 					Initialisation			*/
	/******************************************************************************/
...
*/
	...
	*/
	...
	if (memcmp(sExternalResource, STAND_IN_RESOURCE, 6) == 0)
	{
		...
		if (Activate_Card(nIndiceCtx, sTlvBuffer) != OK)
		{
			return (AuthLocal(nIndiceCtx, sTlvBuffer));
		}
	...
	trace_event("End CardActivationRequestProc(OK)", PROCESSING);
	return(nRetCode);
}
