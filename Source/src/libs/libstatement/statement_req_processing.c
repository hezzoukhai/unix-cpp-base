...
/****************************************************************************/
/****************************************************************************/
int StatementDetailledProcessing (int nIndiceCtx,
				 char *sMyResource,
				 char *sAuthoTable, 
				 char *sAcquirerBank,
				...
				TSIsoInfo *sIsoMsg  )
{
    ...
    trace_event("Start StatementDetailledProcessing  ()",PROCESSING);
...
/******************************************************************************/
	   ...
	   nRetCode = Statemt_Inquiry (nIndiceCtx,sTlvBuffer);
/*
