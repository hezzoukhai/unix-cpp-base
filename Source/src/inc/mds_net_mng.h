...
** 
** <Descr>
**  general header file for "mds" network management
** 
** <Module History>
...
#ifndef MDS_NET_MNG_H
#define MDS_NET_MNG_H
...
/* - Function Declaration Section ------------------------------------------ */
   ...
   int  FCT_NW_MNG_REP_FROM_NW (int nIndexCtx, TSMdsInfo *MdsInfo);
   int  FCT_NW_MNG_REQ_FROM_NW (int nIndexCtx,TSMdsInfo *MdsInfo);
