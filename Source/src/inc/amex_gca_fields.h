#ifndef HPS_AMEX_GCA_FIELDS_H
#define HPS_AMEX_GCA_FIELDS_H
...
#define AMEX_ACQR_REFERENCE_DATA          30
...
#define AMEX_ADTNL_DATA_NATL              46
...
#define AMEX_ENCRYPTION_DATA             110  /*  FZL20221018 PLUTONL-4979*/
